...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var $async$goto = 0,
        ...
        $async$returnValue, t1, t2, kysymykset, seuraava, $async$temp1, $async$temp2;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              seuraava = document.querySelector("#seuraava");
              if (seuraava == null) {
                // goto return
                $async$goto = 1;
                break;
              }
              t1 = J.get$onClick$x(seuraava);
              t2 = t1.$ti;
    ...
    asetaKysymysteksti(teksti) {
      var kohde = document.querySelector("#kysymys");
      if (kohde == null)
        return;
      J.set$text$x(kohde, A._asStringQ(teksti));
    },
    asetaVastausvaihtoehdot(vaihtoehdot) {
      var t1, i,
        kohde = document.querySelector("#vastaukset");
      if (kohde == null)
        return;
      J.get$children$x(kohde).clear$0(0);
    ...
    lisaaVastausvaihtoehto(vaihtoehto) {
      ...
      kohde = t1.querySelector("#vastaukset");
      if (kohde == null)
        return;
      J.get$children$x(kohde).add$1(0, elementti);
    },
  ...
  A.main_closure.prototype = {
    call$1(e) {
      ...
      t1 = t2.$index(t1, 0);
      t2 = J.getInterceptor$asx(t1);
      A.asetaKysymysteksti(t2.$index(t1, "teksti"));
